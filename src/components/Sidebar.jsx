...
const Sidebar = ({ setSidebar }) => {
  const [desplegarLista, setDesplegarLista] = useState(false);

  return (
    <div>
      <div className="flex justify-between p-4">
        <h1 className="text-xl text-black uppercase font-semibold">Logo</h1>
      ...
      <div className="px-4 mt-5">
        ...
        <button
          onClick={() => setDesplegarLista(!desplegarLista)}
          className="flex justify-start gap-3 items-center w-full text-xl text-white font-semibold mb-8 bg-[#558b2f] px-4 py-3 rounded-lg shadow-lg shadow-green-900 md:text-lg md:py-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          <svg
            ...
            stroke="currentColor"
            className={`w-6 h-6 ${
              desplegarLista ? `rotate-90` : `rotate-0`
            } transition-transform duration-300 ease-in-out translate-x-6`}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <ul>
          <Link to="/grupos" onClick={() => setSidebar(false)}>
            <li
              ...
              } transition-all duration-300 flex gap-3 items-center text-xl font-semibold mb-8 pl-5 md:text-lg`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      <div className="bottom-0 absolute w-full">
        <hr className="h-px w-[90%] mx-auto bg-black -translate-y-5" />
        <button className="flex gap-2 items-center justify-start px-5 text-xl font-semibold mb-4 md:text-lg md:py-2 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
